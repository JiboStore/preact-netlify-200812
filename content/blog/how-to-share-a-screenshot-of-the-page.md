...
---
This is a way to share the screenshot. I have to edit the .md file, commit to git and push.

But I don't know if I will be able to add custom content, and if I can made it through REST API calls.

This might not suit my needs.
